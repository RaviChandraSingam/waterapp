...
export const api = {
  ...
  createCommonArea: (data) => request('/common-areas', { method: 'POST', body: JSON.stringify(data) }),
  updateCommonArea: (id, data) => request(`/common-areas/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
